...
public class Key extends Collectible
{
	...
	public Key(Sound clip)
    {
    	super(23, clip, 2); //23 is the Checkpoint class's image index
    }
    public TileEditor.Elem getType()
    {
    	return TileEditor.Elem.KEY;
    }
    ...
    public void setRect(int k, int j)
    {
    	...
    	TextureRegion[][] TempRegions = sprite.split(60, 60);
	...
	{
		//g.drawImage(sprite, (int)rect.x - c.Offset, (int)rect.y, (int)rect.x + (int)rect.width - c.xOffset, (int)rect.y + (int)rect.height, (int)rect.width*imageCount, 0, (int)(rect.width*imageCount + rect.width), sprite.getHeight(iObs), iObs);
